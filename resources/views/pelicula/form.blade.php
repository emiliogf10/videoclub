<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('generoId') }}
            {{ Form::select('generoId', $generos,$pelicula->generoId, ['class' => 'form-control' . ($errors->has('generoId') ? ' is-invalid' : ''), 'placeholder' => 'Generoid']) }}
            {!! $errors->first('generoId', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('duracion') }}
